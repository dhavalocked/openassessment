...
import * as clixSelectors                                          from '../clix/selectors';
...
export function primaryActionState(state, props) {
  return clixSelectors.primaryActionState(state, props);
}

export function secondaryActionState(state, props) {
  return clixSelectors.secondaryActionState(state, props);
}

export function checkButtonText(state, props) {
  return clixSelectors.checkButtonText(state, props);
}